...
-- login server
LOGIN_SERVER_BEGIN = 0x0077FC48
LOGIN_SERVER_END   = 0x007800A8 -- = LOGIN_SERVER_BEGIN + (STEP_LOGIN_SERVER * MAX_LOGIN_SERVERS)

-- creature list
CREATURELIST_BEGIN = 0x0062BD90
CREATURELIST_END   = 0x006359D0 -- = CREATURELIST_BEGIN + (STEP_CREATURE * MAX_CREATURES)

-- container
CONTAINER_BEGIN    = 0x00638160
CONTAINER_END      = 0x00000000 -- = CONTAINER_BEGIN + (STEP_CONTAINER * MAX_CONTAINERS)
